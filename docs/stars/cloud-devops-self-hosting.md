...
**15 repositories.** [Open this live list on GitHub →](https://github.com/stars/ardjo-s/lists/cloud-devops-self-hosting)
...
- [Osmantic/ODS](https://github.com/Osmantic/ODS) — ODS V3 Pre-Release: Public testing and refinement ahead of the official V3 launch.
