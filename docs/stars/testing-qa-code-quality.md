...
- [bug0inc/qa-agent](https://github.com/bug0inc/qa-agent) — The open-source Playwright library for AI browser regression testing with intelligent caching, auto-healing, and multi-model verification.
