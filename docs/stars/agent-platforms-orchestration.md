...
**59 repositories.** [Open this live list on GitHub →](https://github.com/stars/ardjo-s/lists/agent-platforms-orchestration)
...
- [CopilotKit/CopilotKit](https://github.com/CopilotKit/CopilotKit) — The Frontend Stack for Agents & Generative UI.
...
- [Kylejeong2/fusion](https://github.com/Kylejeong2/fusion) — Reference implementation of Devin Fusion.
...
- [ruvnet/ruflo](https://github.com/ruvnet/ruflo) — 🌊 The original agent harness.
