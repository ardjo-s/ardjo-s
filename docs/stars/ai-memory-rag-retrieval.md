...
- [claudioemmanuel/squeez](https://github.com/claudioemmanuel/squeez) — Hook-based token compressor for 7 AI CLI hosts (Claude Code, Copilot CLI, OpenCode, Gemini CLI, Codex CLI, Pi, Hermes).
